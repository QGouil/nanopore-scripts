...
module load bwa
#use nanopolish 0.8.5 that I installed
...
~/wehisan_home/scripts/jts/nanopolish/nanopolish call-methylation -r $INPUT_FASTA -b ${INPUT_FASTA}.sorted.bam -g $GENOME > ${INPUT_FASTA}.methylation.tsv || echo "ERROR: nanopolish failed"
echo "COMPLETE"
